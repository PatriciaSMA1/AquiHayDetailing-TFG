...
public class PantallaMisCitas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // CARGAR DATOS DEL USUARIO (foto + nombre en el menú lateral)
        cargarDatosUsuario();
    ...
    private void cargarCitas() {
        ...
        String uid = FirebaseAuth.getInstance().getCurrentUser().getUid();
        Log.d("CITA_DEBUG", "Cargando citas para UID: " + uid);
                ...
                .addOnSuccessListener(query -> {
                    ...
                    for (DocumentSnapshot doc : query) {
                        ...
                        if (servicio != null && fecha != null && horario != null) {
                            // --- CAMBIO CLAVE AQUÍ: Asignamos el ID del documento de Firebase a la Cita ---
                            Cita citaObj = new Cita(servicio, fecha, horario, precio, tamaño, estado);
                            citaObj.setId(doc.getId()); // Guardamos el ID real de Firestore
                            listaCitas.add(citaObj);
                        }
                    }

                    // Actualizamos el adaptador con la lista corregida
